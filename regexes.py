...
# Regex for InfraToken
INFRA_REGEX = space_boundaries_re(strip_punctuation_re("infra"))

# Regex for AnteToken
ANTE_REGEX = space_boundaries_re(strip_punctuation_re("ante"))

# Regex for MPEPToken
MPEP_REGEX = space_boundaries_re(strip_punctuation_re("mpep|m\.p\.e\.p\."))
